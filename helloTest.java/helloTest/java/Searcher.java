...
public class Searcher {
	...
	static String convertStreamToString(OutputStream is) {
	    Scanner s = new Scanner((Readable) is).useDelimiter("\\A");
...
public static String[] tag(String sentence) throws IOException{
	...
	pb.directory(home);
	 Process p = pb.start();
	String temp = convertStreamToString(p.getOutputStream());
